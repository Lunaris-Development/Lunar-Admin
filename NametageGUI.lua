...
local function ApplyTag(UI)
	...
	local function build()
		...
		local imgUrl = rawId ~= "" and getAsset(tonumber(rawId) or 0, 420) or LogoID
...
local function BuildGUI(UI)
	...
	PImg.Image = ((Config.decalId or ""):match("%d+") or "") ~= "" and (getAsset(tonumber(Config.decalId:match("%d+") or "") or 0, 420)) or LogoID
